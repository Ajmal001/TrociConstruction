				...
				var dataTable = $('#employee-grid').DataTable( {
					...
					"columnDefs": [ {
						  ...
						  "searchable": false,
                                ...
                                "ajax":{
                                    url :"clients-grid-data.php", // json datasource, this has been altered and linked to the relevant php file to extract info fromn the database.
...
$(document).ready(function() {
    ...
    $('#employee-grid tbody').on('click', 'tr', function () {
        ...
        location.href = 'projectTools.php?id='+data[7];
    } );
} );
</script>
