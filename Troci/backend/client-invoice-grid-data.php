...
$sql.=" FROM invoices";
$query=mysqli_query($conn, $sql) or die("client-invoice-grid-data.php: get employees");
...
$cli = "SELECT username ";
$cli.=" FROM clients";
$id=mysqli_query($conn, $sql) or die("client-invoice-grid-data.php: get employees");
...
$sql.=" FROM invoices WHERE client ='$cid'";
...
while( $row=mysqli_fetch_array($query) ) {  // preparing an array
	$nestedData=array(); 
    //the data retrieved has been amended from the original code.
