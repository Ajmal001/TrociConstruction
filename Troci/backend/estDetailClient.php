...
<html>
	...
	<body>
        <?php 
        //getting informaion from the estimate to invoice php page
		...
		<article>
            ...
            <table class="meta" style="margin-left:28%;">
				<tr>
					...
					<td>
                        <div style="text-align:right; width:100%;">
                            <span><?php include("estGetDetail.php"); echo"#N$estID"; ?>
                            </span>
                        </div>
                        <input hidden name="estID" value="<?php include("estGetDetail.php"); echo"$estID"; if(isset($_POST['estID'])) echo $_POST['estID'];?>">
                    </td>
				</tr>
				<tr>
				    <th>
				...
				<tr>
					...
					<td>
                        <span>£
                            <input readonly="readonly" style="text-align:right; width:90%;" class="pull-right" type="number" min="0" step="0.01" value="<?php include("estGetDetail.php"); echo"$bal"; ?>" name="total1" id="total1" > 
                        </span>
                        <span></span>
                    </td>
				</tr>
			...
			<table class="meta">
				<tr>
					...
					<td>
                        <span id="clientName"> <input readonly="readonly" style="width:139px" name="clientName" value="<?php include("estGetDetail.php"); echo"$name"; ?>" value="<?php if(isset($_POST['clientName'])) echo $_POST['clientName']; ?>"> 
                        </span>
                    </td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td >
                        <span name="town"><input readonly="readonly" style="width:139px" name="town" value="<?php include("estGetDetail.php"); echo"$town"; ?>" value="<?php if(isset($_POST['town'])) echo $_POST['town']; ?>"> 
                        </span>
                        <span></span>
                    </td>
				</tr>
			...
			<table class="inventory">
				...
				<tbody>
                    ...
                    <tr>
						...
						<td>				
                            <span id="clientName">£     <input readonly="readonly" class="pull-right" style="text-align:right; width:90%;" onblur="pertot()" value="<?php include("estGetDetail.php"); echo"$descprice3"; ?>" name="qty[]" id="qty4" value="<?php if(isset($_POST['qty[3]'])) echo $_POST['qty[3]']; ?>" required> 
                            </span>
                        </td>
					</tr>
                    <tr>
