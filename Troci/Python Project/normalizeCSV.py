...
# learning: boolean determining if the csv file provided contains learning or testing data, normalize: Should the data be normalized before saved into 'data'
...
# Here I try to find a pattern in our data.
...
outputHeaders = ['', "Description", "Job Date", "Document Number", "Address", "Ward", "Client", "Agent", "Status", "Prediction"]

# Write prediction CSV file
with open('AllJobs.csv', "w") as csv_file:
	...
	rows = zip(strs, testingDataOriginal["Description"], testingDataOriginal["Job Date"],
	 testingDataOriginal["Document Number"], testingDataOriginal["Address"], testingDataOriginal["Ward"],
