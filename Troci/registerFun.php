...
*****************************************************************************************************/
    if(count($_POST)>0) {
        ...
        if(!isset($message)) {
            ...
            $query = "INSERT INTO clients (firstname, surname, address, town, postcode, email, phone, username, password) VALUES
            ('" . $_POST["firstName"] . "', '" . $_POST["lastName"] . "', '" . $_POST["address"] . "', '" . $_POST["city"] . "', '" . $_POST["postcode"] . "', '" . $_POST["email"] . "', '" . $_POST["phone"] . "', '" . $_POST["username"] . "', '$password')";
