				...
				var dataTable = $('#employee-grid').DataTable( {
					...
					"columnDefs": [ {
						  ...
						  "searchable": false,   
                                ...
                                "ajax":{
                                    url :"estimate-grid-data.php", // json datasource, this has been altered and linked to the relevant php file to extract info fromn the database.
...
$(document).ready(function() {
    ...
    $('#employee-grid tbody').on('click', 'tr', function () {
        ...
        location.href = 'estDetail.php?id='+data[4];
    } );
} );
</script>
</html>
