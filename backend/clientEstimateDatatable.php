				...
				var dataTable = $('#employee-grid').DataTable( {
					...
					"columnDefs": [ {
						  ...
						  "searchable": false,
                            ...
                            "ajax":{
                                url :"client-estimate-grid-data.php", // json datasource, this has been altered and linked to the relevant php file to extract info fromn the database.
			...
			<table id="employee-grid"  cellpadding="0" cellspacing="0" border="0" class="display" width="100%">
					<thead>
						<tr>
							...
							<th>Estimate ID</th>
                            <th id="info">Client Name</th>
							<th id="info">Address</th>
                            <th id="info">Estimate Total</th>
						</tr>
					</thead>
            </table>        
		</div>
...
$(document).ready(function() {
    ...
    $('#employee-grid tbody').on('click', 'tr', function () {
        ...
        location.href = 'estDetailClient.php?id='+data[4]; 
    } );
} );
</script>
</html>
