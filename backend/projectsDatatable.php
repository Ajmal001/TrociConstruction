				...
				var dataTable = $('#employee-grid').DataTable( {
					...
					"columnDefs": [ {
						  ...
						  "searchable": false,
                                ...
                                "ajax":{
                                    url :"project-grid-data.php", // json datasource, this has been altered and linked to the relevant php file to extract info fromn the database.
			...
			<table id="employee-grid" data-toggle="modal" data-target="#myModal" cellpadding="0" cellspacing="0" border="0" class="display" width="100%">
					<thead>
						<tr>
                            ...
                            <th id="info">Probability <center>(%)</center></th>
						</tr>
					</thead>
			</table>
		</div>
...
$(document).ready(function() {
    ...
    $('#employee-grid tbody').on('click', 'tr', function () {
        ...
        location.href = 'propLetter.php?id='+data[7];
    } );
} );
</script>
</html>
